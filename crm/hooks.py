...
# ------------------
fixtures = [
	{"dt": "Client Script", "filters": [["name", "=", "Opportunity Client Script"]]},
	{"dt": "Client Script", "filters": [["name", "=", "Follow Up Script"]]},
]
# required_apps = []
...
# 	"Task": "crm.custom.task.CustomTaskMixin"
# }
